...
const Keyboard = ({ power, play, sounds, style }) => (
  <div className="keyboard">
    {power
      ? sounds.map((sound) => (
          <KeyboardKey sound={sound} play={play} style={style} />
        ))
      : sounds.map((sound) => (
          <KeyboardKey
            sound={{ ...sound, url: "#" }}
    ...
    <button
      ...
      style={
        power
          ...
          : { color: "white", boxShadow: "2px 2px 3px grey" }
      }
    >
      Change Sound Group
    </button>
    ...
    <h2
      ...
      style={
        power
          ...
          : { backgroundColor: "#78828E", color: "#78828E" }
      }
    >
...
const App = () => {
  ...
  return (
    <div id="drum-machine">
      {setKeyVolume()}
      <Keyboard play={play} sounds={sounds} power={power} style={style} />
      <DrumControll
        volume={volume}
